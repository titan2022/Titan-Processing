...
file(GLOB_RECURSE JAVA_SRC CONFIGURE_DEPENDS ${CMAKE_SOURCE_DIR}/test/server/*.java)
...
file(GLOB test_sources CONFIGURE_DEPENDS ${CMAKE_SOURCE_DIR}/test/client/*.cpp)
foreach(test_source ${test_sources})
    get_filename_component(test_source_name ${test_source} NAME_WE)
    add_executable(${test_source_name} ${test_source})
    target_include_directories(${test_source_name} PUBLIC ${gtest_SOURCE_DIR}/include ${gtest_SOURCE_DIR} PRIVATE ${CMAKE_SOURCE_DIR}/include)
    target_link_libraries(${test_source_name} gtest gtest_main TitanProcessing ${OpenCV_LIBS})
...
add_executable(test_client_exec ${CMAKE_SOURCE_DIR}/test/client/util/test_client_exec.cpp)
target_include_directories(test_client_exec PRIVATE ${CMAKE_SOURCE_DIR}/include)
target_link_libraries(test_client_exec TitanProcessing)
